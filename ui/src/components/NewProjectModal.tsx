...
type Step = 'name' | 'folder' | 'complete'
        ...
        {step === 'name' && (
          <form onSubmit={handleNameSubmit}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              >
                <Github size={14} style={{ color: '#6A6A20' }} />
                GitHub Repository
                <span style={{ fontSize: '11px', fontWeight: 400, color: '#6A6A20' }}>(optional)</span>
              </label>
              <input
                id="github-repo"
                type="text"
              ...
              <p style={{ fontSize: '12px', color: '#6A6A20', margin: '6px 0 0' }}>
                Link a GitHub repo to enable push-to-repo and PR workflows.
              </p>
            </div>
